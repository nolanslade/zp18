...
\begin{figure}[h!]
\centering
\includegraphics[scale=0.3]{WallUI.png}
...
\begin{figure}[h!]
\centering
\includegraphics[scale=0.25]{InstructionText.png}
...
\begin{figure}[h!]
\centering
\includegraphics[scale=0.27]{Output.png}
...
\textbf{Virtual\_Hand\_Left\slash Right}: \newline \newline
